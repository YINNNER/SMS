					...
					<div class="col-sm-12 col-md-12 main">
						...
						<form class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="inputInstitute" placeholder="学院">
								</div>
							</div>
							<div class="form-group">
								<label for="inputMajor" class="col-sm-2 col-sm-offset-1 control-label">专业</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="inputMajor" placeholder="专业">
								</div>
							</div>
							<div class="form-group">
								<label for="inputBirth" class="col-sm-2 col-sm-offset-1 control-label">出生年月</label>
								<div class="col-sm-6">
									<input type="date" class="form-control" id="inputBirth" placeholder="年/月/日">
								</div>
							</div>
							<div class="form-group">
								<label for="inputBirthPlace" class="col-sm-2 col-sm-offset-1 control-label">籍贯</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="inputBirthPlace" placeholder="籍贯">
								</div>
							</div>
							<div class="form-group">
								<label for="inputPolitical" class="col-sm-2 col-sm-offset-1 control-label">政治面貌</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="inputPolitical" placeholder="政治面貌">
								</div>
							</div>
							<div class="form-group">
